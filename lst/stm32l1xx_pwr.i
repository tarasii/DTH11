#line 1 "..\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_pwr.c"
...
#line 198 "..\\STM32L1xx_StdPeriph_Driver\\inc\\stm32l1xx_pwr.h"
...
#line 33 "..\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_pwr.c"
#line 34 "..\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_pwr.c"
...
void PWR_WakeUpPinCmd(uint32_t PWR_WakeUpPin, FunctionalState NewState)
{
  ...
  tmp = (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x04) * 32) + (0x08 * 4)) + PWR_WakeUpPin;
  
  *(volatile uint32_t *) (tmp) = (uint32_t)NewState;
}
...
void PWR_FastWakeUpCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x0A * 4)) = (uint32_t)NewState;
}
...
void PWR_VoltageScalingConfig(uint32_t PWR_VoltageScaling)
{
  ...
  tmp = ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR;

  tmp &= ((uint32_t)0xFFFFE7FF);
  tmp |= PWR_VoltageScaling;
  
  ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR = tmp & 0xFFFFFFF3;
...
void PWR_EnterLowPowerRunMode(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR |= ((uint16_t)0x0001);
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR |= ((uint16_t)0x4000);     
  }
  else
  {
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR &= (uint32_t)~((uint32_t)((uint16_t)0x4000)); 
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR &= (uint32_t)~((uint32_t)((uint16_t)0x0001));  
  }  
}
