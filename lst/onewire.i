...
void OW_SendBits(uint8_t num_bits) {
	...
	DMA_DeInit(((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x20000) + 0x6000) + 0x006C)));
	DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t) &(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->DR);
	...
	DMA_Init(((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x20000) + 0x6000) + 0x006C)), &DMA_InitStructure);

	
	DMA_DeInit(((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x20000) + 0x6000) + 0x0080)));
	DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t) &(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->DR);
	DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t) ow_buf;
	...
	DMA_InitStructure.DMA_Priority = ((uint32_t)0x00000000);
	DMA_InitStructure.DMA_M2M = ((uint32_t)0x00000000);
	DMA_Init(((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x20000) + 0x6000) + 0x0080)), &DMA_InitStructure);

	
	USART_ClearFlag(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0020) | ((uint16_t)0x0040) | ((uint16_t)0x0080));
	USART_DMACmd(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0080) | ((uint16_t)0x0040), ENABLE);
	DMA_Cmd(((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x20000) + 0x6000) + 0x006C)), ENABLE);
	...
	DMA_Cmd(((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x20000) + 0x6000) + 0x006C)), DISABLE);
	USART_DMACmd(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0080) | ((uint16_t)0x0040), DISABLE);
...
uint8_t OW_Scan(uint8_t *buf, uint8_t num) {
        ...
        while (found < num) {
                ...
                OW_Send(1, (uint8_t*)"\xf0", 1, 0, 0, 0xff);
