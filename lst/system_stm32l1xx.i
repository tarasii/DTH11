...
void SystemCoreClockUpdate (void)
{
  ...
  switch (tmp)
  {
    ...
    case 0x0C:   
      ...
      if (pllsource == 0x00)
      {
        ...
        SystemCoreClock = (((((uint32_t)16000000)) * pllmul) / plldiv);
      }
      else
      {
         
        SystemCoreClock = (((((uint32_t)8000000)) * pllmul) / plldiv);
      }
      break;
    default:  
      msirange = (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3800))->ICSCR & ((uint32_t)0x0000E000)) >> 13;
  ...
  tmp = AHBPrescTable[((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3800))->CFGR & ((uint32_t)0x000000F0)) >> 4)];
...
static void SetSysClock(void)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3800))->CR |= ((uint32_t)((uint32_t)0x00000001));
 
   
  do
  {
    HSIStatus = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3800))->CR & ((uint32_t)0x00000002);
  } while((HSIStatus == 0) && (StartUpCounter != ((uint16_t)0x0500)));

  if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3800))->CR & ((uint32_t)0x00000002)) != RESET)
  {
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3800))->CFGR |= (uint32_t)((uint32_t)0x00000000);
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3800))->CFGR &= (uint32_t)((uint32_t)~(((uint32_t)0x00000003)));
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3800))->CFGR |= (uint32_t)((uint32_t)0x00000001);

     
    while ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3800))->CFGR & (uint32_t)((uint32_t)0x0000000C)) != (uint32_t)((uint32_t)0x00000004))
    {
    }
  }
  else
