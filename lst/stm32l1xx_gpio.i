#line 1 "..\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_gpio.c"
...
#line 355 "..\\STM32L1xx_StdPeriph_Driver\\inc\\stm32l1xx_gpio.h"
...
#line 79 "..\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_gpio.c"
#line 80 "..\\STM32L1xx_StdPeriph_Driver\\src\\stm32l1xx_gpio.c"
...
void GPIO_DeInit(GPIO_TypeDef* GPIOx)
{
  ...
  if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000)))
  {
    RCC_AHBPeriphResetCmd(((uint32_t)0x00000001), ENABLE);
    RCC_AHBPeriphResetCmd(((uint32_t)0x00000001), DISABLE);  
  }
  else if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0400)))
  {
    RCC_AHBPeriphResetCmd(((uint32_t)0x00000002), ENABLE);
    RCC_AHBPeriphResetCmd(((uint32_t)0x00000002), DISABLE);
  }
  else if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0800)))
  {
    RCC_AHBPeriphResetCmd(((uint32_t)0x00000004), ENABLE);
    RCC_AHBPeriphResetCmd(((uint32_t)0x00000004), DISABLE);
  }
  else if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0C00)))
  {
    RCC_AHBPeriphResetCmd(((uint32_t)0x00000008), ENABLE);
    RCC_AHBPeriphResetCmd(((uint32_t)0x00000008), DISABLE);
  }
  else if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000)))
  {
      RCC_AHBPeriphResetCmd(((uint32_t)0x00000010), ENABLE);
      RCC_AHBPeriphResetCmd(((uint32_t)0x00000010), DISABLE);
  }
  else
  {
    if(GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1400)))
    {
      RCC_AHBPeriphResetCmd(((uint32_t)0x00000020), ENABLE);
      RCC_AHBPeriphResetCmd(((uint32_t)0x00000020), DISABLE);
    }
  }
}
